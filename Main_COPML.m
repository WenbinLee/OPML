...
for jjj=1:12
    ...
    for  iii=1:S_num
        ...
        %%The COPML Method
        tic;
        [L, Pair_num, Triplet_num,aver_time] = OML_COPML(train_data, train_label, lambda1, lambda2);
        t=toc;
    ...
    Triplet_Pair_Num(jjj,1)=Triplet_num;
    Triplet_Pair_Num(jjj,2)=Pair_num;
